...
interface TestERC721Interface extends ethers.utils.Interface {
  functions: {
    ...
    "awardItem(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "awardItem", values: [string]): string;
...
export class TestERC721 extends Contract {
  ...
  staticCall: {
    ...
    awardItem(player: string, overrides?: Overrides): Promise<BigNumber>;
  ...
  estimateGas: {
    ...
    awardItem(player: string): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    awardItem(player: string): Promise<PopulatedTransaction>;
